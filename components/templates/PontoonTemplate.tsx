...
export type PontoonPageData = {
  ...
  rules?: PontoonSection;
  strategy?: PontoonSection;
  tables?: PontoonTable[];
  tips?: string[];
...
export default function PontoonTemplate({ data }: { data: PontoonPageData }) {
  const d = data;
  return (
