...
export const sweetBonanzaCandyland: GameShowPageContent = {
  ...
  educational: [
    ...
    },
    {
      ...
      paragraphs: [
        "🆕リリース間もないスロットを楽しもう🆕",
        "[最新オンカジスロットをチェック★](LINK_NEEDS_REPAIR)</>,
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "🤩CasinoTsu限定ボーナスも盛りだくさん！ [全てのお得なオファーを今すぐチェック！](LINK_NEEDS_REPAIR)</>,
      ],
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "[スーパーチリペッパー・エピックスピンズ（Extra Chilli Epic Spins）をチェック](LINK_NEEDS_REPAIR)</>,
      ...
      subsections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "**責任あるギャンブル**: 高額賞金が狙える一方で、損失のリスクも伴います。ご自身の資金状況を把握し、楽しむ範囲でプレイすることを心がけましょう。CasinoTsuは、常に責任あるギャンブルを推奨いたします。[responsible gambling](LINK_NEEDS_REPAIR)</>,
          ]
        }
      ]
    },
