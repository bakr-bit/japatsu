...
彼のポーカー界における影響力は、プレイの腕前だけにとどまりません。1978年に自費出版された彼の著書「Super Systems」は、[ポーカーの戦略](LINK_NEEDS_REPAIR)や考え方について詳細に解説されており、多くのプレイヤーに影響を与え、ポーカーのスタイルを大きく変えたと言われています。
